...
export type Project = {
  ...
  /** A body entry is normally a paragraph. `{ quote: "…" }` sets an isolated
      ...
      display type instead of shrinking it to paragraph size. A source photo
      (a movie still, a market reference) belongs in `media` alongside the
      real work, captioned "Reference, …" — see
    ...
    projects: [
      {
        ...
        media: [
          ...
          },
          {
            ...
            caption: "Reference, Liar Liar (1997)",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        media: [
          ...
          },
          {
            ...
            caption: "Reference, Do the Right Thing (1989)",
          },
          {
            ...
            caption: "Reference, modeling in Blender",
          },
          {
            ...
            caption: "Reference, an existing 222 ring",
          },
          {
            ...
            caption: "Reference, real-world dimensions",
          },
        ],
      },
      {
